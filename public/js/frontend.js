...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}]],\"env\":{\"test\":{\"presets\":[[\"env\",{\"targets\":{\"node\":\"current\"}}]]},\"development\":{\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":\"> 2%\",\"uglify\":true}}]]},\"production\":{\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":\"> 2%\",\"uglify\":true}}]]}}}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/frontend/components/ListingsComponent.vue":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		getListings: function getListings() {
			...
			window.axios.get('cars-for-sale').then(function (response) {
		...
		getMakes: function getMakes() {
			...
			window.axios.get('/make').then(function (response) {
				_this3.makes = response.data;
			});
		},
		filterByCat: function filterByCat() {
			var _this4 = this;

			this.listings = {};
			window.axios.get('/category/' + this.category).then(function (response) {
				_this4.listings = response.data;
			});
		},
		filterByMake: function filterByMake() {
			var _this5 = this;

			this.listings = {};
			window.axios.get('/make/' + this.make).then(function (response) {
				_this5.listings = response.data;
			});
		}
		// getModels() {
		// 	this.models = "";
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-7a273c04\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/frontend/components/ListingsComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
      ...
      _c("div", { staticClass: "card" }, [
        ...
        _c("div", { staticClass: "card-body" }, [
          _c("div", { staticClass: "form-group mt-3" }, [
            _c("label", { attrs: { for: "" } }, [_vm._v("Filter By Category")]),
            _vm._v(" "),
            _c(
              "select",
              {
          ...
          _vm._v(" "),
          _c("div", { staticClass: "form-group mt-3" }, [
            _c("label", { attrs: { for: "" } }, [_vm._v("Filter By Make")]),
            _vm._v(" "),
            _c(
              "select",
              {
        ...
        _c("div", { staticClass: "card-body" }, [
          _c(
            ...
            _vm._l(_vm.listings, function(listing) {
              return _vm.listings.length
                ? _c(
                    "div",
                    {
                      staticClass:
                        "col car-lists border-top border-warning pb-2"
                    },
                    [
                        ...
                        _c("div", { staticClass: "media-body" }, [
                          ...
                          _c("div", { staticClass: "row" }, [
                            _c("div", { staticClass: "col" }, [
                              ...
                              _vm._v(" " + _vm._s(listing.make.name)),
                              _c("br"),
                              _vm._v(" "),
                              _c("strong", {}, [_vm._v("Model:")]),
                              _vm._v(" " + _vm._s(listing.model.name)),
                              _c("br"),
                              _vm._v(" "),
                            ...
                            _c("div", { staticClass: "col" }, [
                              _c("span", [
                                ...
                                _vm._v(
                                  " " +
                                    _vm._s(
                                      _vm._f("timeago")(listing.created_at)
                                    )
                                )
                              ]),
                              _c("br"),
                              ...
                              _c("span", [
                                ...
                                _vm._v(
                                  " " +
                                    _vm._s(
                                      listing.is_offer ? "Offer" : listing.price
                                    )
                                )
                              ])
                            ]),
                ...
                : _c("div", [_c("p", [_vm._v("No result found")])])
            }),
            0
          )
        ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7a273c04", module.exports)
  }
}
...
__WEBPACK_IMPORTED_MODULE_2_vue___default.a.component('listings-component', __webpack_require__("./resources/js/frontend/components/ListingsComponent.vue"));
...
/***/ "./resources/js/frontend/components/ListingsComponent.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}]],\"env\":{\"test\":{\"presets\":[[\"env\",{\"targets\":{\"node\":\"current\"}}]]},\"development\":{\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":\"> 2%\",\"uglify\":true}}]]},\"production\":{\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":\"> 2%\",\"uglify\":true}}]]}}}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/frontend/components/ListingsComponent.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-7a273c04\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/frontend/components/ListingsComponent.vue")
/* template functional */
var __vue_template_functional__ = false
/* styles */
var __vue_styles__ = null
...
Component.options.__file = "resources\\js\\frontend\\components\\ListingsComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7a273c04", Component.options)
  } else {
    hotAPI.reload("data-v-7a273c04", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
