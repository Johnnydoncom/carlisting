<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4" id="frontend-navbar">
        ...
        <form class="form-inline mx-2">
            <div class="input-group">
                ...
                <div class="input-group-append">
                 <button class="btn btn-outline-primary btn-sm my-2 my-sm-0" type="submit"><i class="fa fa-search"></i></button>
             </div>
            </div>  
        </form>
